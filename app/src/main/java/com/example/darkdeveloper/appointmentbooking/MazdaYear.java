...
public class MazdaYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mazda_year);
        listView = (ListView) findViewById(R.id.lv_mazdayear);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (i == 0) {
                    Intent intent = new Intent(MazdaYear.this, MazdaModel.class);
