...
public class HondaYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_honda_year);
        listView = (ListView) findViewById(R.id.lv_hondayear);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (i == 0) {
                    Intent intent = new Intent(HondaYear.this, HondaModel.class);
