...
public class ToyotaYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toyota_year);
        listView = (ListView) findViewById(R.id.lv_toyotayear);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (i == 0) {
                    Intent intent = new Intent(ToyotaYear.this, ToyotaModel.class);
